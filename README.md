...
- 🏫 I’m a Graduate TA and student pursuing a master's program in computer science, ML at Johns Hopkins University
- 🌱 &nbsp;I'm on track for learning more about ```Machine Learning``` • ```AI``` • ```Systems Design```• ```Assembly Language``` • ```Data Science``` 
